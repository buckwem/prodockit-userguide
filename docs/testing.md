...
This is the last of the "Start Here" reference pages. Continue to [Finalising your document](customisecontent.md#finalising-your-document) in Customise document content once your report itself is ready to submit - removing `starthere/` (this page included) is part of that step.
